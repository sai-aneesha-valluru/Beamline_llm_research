...
# ---------------------------------------------------------
# LORA TARGETS (QWEN COMPATIBLE)
# ---------------------------------------------------------

def get_lora_targets(model_name: str):
    ...
    if "qwen" in name:
        ...
        # fallback for mistral/llama-style
        return [
            "q_proj",
            "k_proj",
            "v_proj",
...
def train(cfg: TrainConfig):
    ...
    lora_config = LoraConfig(
        r=16,
        lora_alpha=32,
        target_modules=get_lora_targets(cfg.base_model),
        lora_dropout=0.1,
        bias="none",
        task_type="CAUSAL_LM",
    )
    ...
    print(f"\nFinal merged model saved to: {merged_dir}")
